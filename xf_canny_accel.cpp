...
// clang-format off
    ...
    xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, INTYPE> blur_mat(rows, cols);
...
#pragma HLS DATAFLOW
    ...
    xf::cv::GaussianBlur<BLUR_FILTER_W,XF_BORDER_CONSTANT,XF_8UC1,HEIGHT, WIDTH,INTYPE>(in_mat, blur_mat, sigma);
    xf::cv::Canny<FILTER_WIDTH, NORM_TYPE, XF_8UC1, XF_2UC1, HEIGHT, WIDTH, INTYPE, XF_NPPC32, XF_USE_URAM>(blur_mat, dst_mat, low_threshold, high_threshold);
